...
int estado = 0;             // the current state of the output pin
...
#define LAMP_1 "luz living" // Nombre del dispositivo en Alexa
#define LAMP_2 "luz rincon"
...
void setup()
{
  ...
  Serial.println("Empezando a Conectar...");
  ...
  fauxmo.
      ...
      fauxmo.onSetState([](unsigned char device_id, const char *device_name, bool state, unsigned char value) {
        ...
        {
          digitalWrite(luz, state ? HIGH : LOW);
        }
      });
}
